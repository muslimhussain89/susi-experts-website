...
import { Eb1A_FAQs } from "../../Components/AllServicesContent";
import { useLocation } from "react-router-dom";
import Eb1BServiceTabs from "../../Components/Eb1BServiceTabs";
export default function Eb1AFaqs() {
  ...
  return (
    <>
    {active === "/eb1-a/eb1-a-faqs" ? (
           <ServicesBread bread3={"EB1-A"} bread4={"Faq's of EB1-A"} />
          ) : (
            <ServicesBread bread3={"EB1-B"} bread4={"Faq's of EB1-B"} />
          )}
      ...
      <div className="ServiceDetailSection">
        <div className="Container">
          <p className="service-name">
            Frequently Asked Questions for EB1-A (Alien of Extraordinary
            Ability)
          </p>
          {active === "/eb1-a/eb1-a-faqs" ? (
            <Eb1ServiceTabs />
